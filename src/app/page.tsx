      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Anthony, a software engineer and dog lover. When I’m not solving
            problems with code, I’m probably playing with my dogs, or playing
            video games. Catch me on Apex Legends, or Overwatch 2.
          </p>
          <div className="mt-6 flex gap-6">
            {/* TODO: Actually post things to X */}
            {/* <SocialLink
              href="https://x.com"
            ...
            /> */}
            <SocialLink
              href="https://github.com/AnthonyW90"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/anthonytwallace/"
